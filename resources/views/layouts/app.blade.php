        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                @auth
                    ...
                    <li>
                        <a href="{{route('superadmin.users.index')}}" class="waves-effect {{$_SERVER['REQUEST_URI'] == '/superadmin/users' ? ' active' : ''}}"><i class="fa fa-users fa-fw" aria-hidden="true"></i>Manage Users</a>
                    </li>
                    <li>
