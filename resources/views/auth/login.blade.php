                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" class="form-control form-control-lg" placeholder="Email Address" aria-label="Username" name="email" aria-describedby="basic-addon1" required="" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                        ...
                        @csrf
                            ...
                            <div class="row m-t-20 p-t-20 border-top border-secondary">
                                <div class="col-12">
                                    ...
                                    <button class="btn btn-info float-right" type="submit" name="action">{{ __('Reset Password') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
